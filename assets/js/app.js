const products = [
    { id: 23, name: "LV New Collection", brand: "LOUIS VUITTON", price: 635, image: "assets/images/products/1778807998099.jpg", colors: ["brown", "gold"], category: "curated" },
    { id: 24, name: "LV New BOKKEY", brand: "GOARD", price: 595, image: "assets/images/products/1778807998013.jpg", colors: ["brown", "gold"], category: "curated" },
...
function loadProducts() {
    ...
    const shopGridContainer = document.getElementById('shopGrid');

    if (latestContainer) {
        // แสดงทั้ง latest และ curated ในส่วนแรกของหน้าแรก
        const latestProducts = products.filter(p => p.category === 'latest' || p.category === 'curated');
